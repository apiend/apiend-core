...
func prepareEmail() *Email {
	e := NewEmail()
	e.From = "Jordan Wright <service@apiend.com>"
	e.To = []string{"233894432@qq.com"}
	e.Bcc = []string{"233894432@qq.com"}
	e.Cc = []string{"233894432@qq.com"}
...
func TestEmailText(t *testing.T) {
	...
	e.Send("smtp.exmail.qq.com:465",smtp.PlainAuth("", "service@apiend.com", "Dio81106473", "smtp.exmail.qq.com"))
	// msg := basicTests(t, e)
